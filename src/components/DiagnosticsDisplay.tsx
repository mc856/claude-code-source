...
export function DiagnosticsDisplay(t0: DiagnosticsDisplayProps): React.ReactNode {
  const $ = _c(14);
  const {
    attachment,
    verbose
...
function _temp3(file_0: DiagnosticsAttachment['files'][number], fileIndex: number): React.ReactNode {
...
function _temp2(diagnostic: DiagnosticsAttachment['files'][number]['diagnostics'][number], diagIndex: number): React.ReactNode {
...
function _temp(sum: number, file: DiagnosticsAttachment['files'][number]): number {
