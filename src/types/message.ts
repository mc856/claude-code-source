// Restored type shim for source trees reconstructed from the bundled CLI.
// These aliases intentionally stay broad so tsc can distinguish "missing
// source/type entrypoints" from actual code-level errors elsewhere.
