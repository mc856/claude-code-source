...
Dependency note: this change builds on provider-layer code introduced under `provider-abstraction`. Only work implemented and validated specifically for this change should be marked complete here.
